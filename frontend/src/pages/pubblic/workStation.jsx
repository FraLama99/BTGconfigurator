...
const WorkStation = () => {
  ...
  const fetchWorkstations = async () => {
    ...
    try {
      ...
      const categorieDaCercare = ["workstation", "office"];
      ...
      setError("Errore nel caricamento delle workstation preconfigurate");
      console.error(err);
    } finally {
      setLoading(false);
    }
  ...
  const filteredMachines = machines.filter((machine) => {
    ...
    if (
      filters.minPrice &&
      machine.basePrice &&
      machine.basePrice < parseFloat(filters.minPrice)
    ) {
      return false;
    }
    ...
    if (
      filters.maxPrice &&
      machine.basePrice &&
      machine.basePrice > parseFloat(filters.maxPrice)
    ) {
      return false;
    }
    ...
    <div className="bg-dark text-light py-5">
      <Container>
        <h1 className="text-center mb-5">
          Workstation e PC Office Preconfigurati
        </h1>
              ...
              {filteredMachines.length === 0 && (
                <Col xs={12}>
                  <div className="text-center py-5">
                    <i className="bi bi-exclamation-circle fs-1 text-info mb-3"></i>
